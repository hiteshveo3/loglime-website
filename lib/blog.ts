...
export const blogPosts: BlogPost[] = [
  ...
  {
    title: "Restaurant App vs Talabat, Deliveroo & DoorDash: Revenue Comparison",
    slug: "restaurant-app-vs-delivery-platforms",
    excerpt: "Compare exact costs & commissions. See how restaurants save AED 25K–50K monthly by shifting from platforms to their own app.",
    categorySlug: "restaurant-growth",
    authorUsername: author,
    featuredImage: "/images/loglime/online-ordering-system-loglime.webp",
    featuredImageAlt: "Restaurant app vs delivery platforms cost comparison",
    featuredImageCaption: "Platforms take 25–30% per order. Your app takes 3%.",
    tags: ["delivery-platforms", "cost-comparison", "direct-ordering", "margins"],
    ...
    sections: [
      {
        ...
        heading: "Commission breakdown: What you actually pay",
        answer: "All major platforms charge 15–30% commission. But that's just the headline number.",
        body: [
        ...
        table: {
          columns: ["Fee", "Percentage", "What It Is"],
          rows: [
        ...
        callout: {
          tone: "important",
          title: "Real example",
          body: "A $100 order on DoorDash: Commission ($25) + Processing ($2.50) + Marketing ($3–5) = $30.50–32.50 lost. You keep $67.50–69.50.",
        },
      },
      {
        id: "hidden-problem-control",
        heading: "The hidden problem: You have zero control",
        answer: "Commissions hurt. But loss of control hurts more.",
        body: [
      ...
      {
        id: "the-math",
        heading: "The math: Platform vs your own app",
        answer: "Let's compare a real independent burger restaurant across channels.",
        body: [
        ...
        table: {
          columns: ["Scenario", "Daily Cost", "Monthly Cost", "Yearly Cost"],
          rows: [
        ...
        callout: {
          ...
          body: "This assumes 70/30 split. Restaurants that push their app often hit 80/20 or 90/10 within a year, saving even more.",
        },
      },
      {
        id: "why-customers-switch",
        heading: "Why customers will actually switch",
        answer: "Customers love DoorDash... until your app is more convenient.",
        body: [
        ...
        callout: {
          tone: "tip",
          title: "Real adoption curve",
          body: "Week 1: 5% download. Month 1: 15% use regularly. Month 3: 35% prefer app. Month 6: 50–60% of orders through app.",
        },
      },
      {
        id: "platform-comparison",
        heading: "Platform comparison: Which one should you actually use?",
        answer: "If you must be on platforms, here's how they rank by market.",
        body: [
      ...
      {
        id: "your-own-app",
        heading: "The alternative: Your own app",
        answer: "Building an app used to cost $20,000+ and take 6+ months. Modern platforms changed that.",
        body: [
    ...
    faqs: [
      {
        question: "Don't I need to be on all platforms to succeed?",
        answer: "No. Being on too many platforms dilutes your brand. Pick 1–2 and dominate your own app.",
      },
      {
        question: "What if customers can't find my app?",
        answer: "QR code on receipt, Instagram bio, in-store signs, email to existing customers. Usually gets 40% adoption in month 1.",
      },
      {
        question: "What about delivery? I don't have my own drivers.",
        answer: "Keep 20–30% on platforms for delivery. Use your app for orders. Or hire 1 driver if you're doing 50+ deliveries/day.",
      },
      {
        question: "Isn't building an app complicated?",
        answer: "Not anymore. Modern app builders handle everything. You provide menu and branding.",
      },
      {
        question: "What if I'm a small restaurant with 20 orders/day?",
        answer: "This works better for small restaurants. You serve loyal customers directly without platform algorithms hurting you.",
      },
      {
        question: "How long until the app pays for itself?",
        answer: "4–6 months. After that, it's pure profit and customer loyalty growth.",
      },
    ],
    conclusion: "The question isn't 'Platform or app.' It's 'How much money am I willing to give away?' Every $100 order through DoorDash costs you $30. Every $100 through your app costs $3. That $27 difference, across 80 orders/day, is $23,000–50,000 per month. Most restaurants wouldn't write a $30,000/month check to DoorDash. But that's what they're doing. Your own app changes everything.",
  },
  {
