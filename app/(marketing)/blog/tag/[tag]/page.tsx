...
export async function generateMetadata({ params }: { params: Promise<{ tag: string }> }): Promise<Metadata> {
  ...
  return {
    title: `${tag} Articles | Loglime Blog`,
    description: `Loglime blog articles tagged ${tag}.`,
    alternates: { canonical: `https://loglime.com/blog/tag/${tag}` },
  };
}
  ...
  return (
    <main className="bg-surface-alt">
      <section className="mx-auto max-w-page px-4 py-14 lg:px-8 lg:py-20">
        ...
        <h1 className="mt-3 text-h1 text-text-primary">#{tag}</h1>
